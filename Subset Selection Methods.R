## Kenny Warner
## Objective: Compare different subset selection methods
## Anaylzing a credit data set to determine the likelihood of default
## Three subset selection methods that are being used are
...
##Implement the package leaps to use the subset selection methods
library(leaps)
